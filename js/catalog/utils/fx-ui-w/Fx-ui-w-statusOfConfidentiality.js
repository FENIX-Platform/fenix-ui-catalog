define([
    ...
    function Fx_ui_w_statusOfConfidentiality() {
        w_commons = new W_Commons();
    }

    Fx_ui_w_statusOfConfidentiality.prototype.validate = function (e) {
    ...
    Fx_ui_w_statusOfConfidentiality.prototype.bindEventListeners = function () {
 ...
 /*       document.body.addEventListener(o.events.DESELECT + o.module.type, function (e) {
    ...
    Fx_ui_w_statusOfConfidentiality.prototype.getCodelist = function () {
        ...
        $.ajax({
            ...
            error: function () {
                alert("Fx_ui_w_statusOfConfidentiality error: impossible to load codelist");
            }
        });

    };

    Fx_ui_w_statusOfConfidentiality.prototype.printList = function (data) {
    ...
    Fx_ui_w_statusOfConfidentiality.prototype.deselectValue = function (obj) {
        var item = $(o.container).jqxListBox('getItemByValue', obj.value);
        $(o.container).jqxListBox('unselectItem', item);
    };

    Fx_ui_w_statusOfConfidentiality.prototype.getValue = function (e) {
    ...
    return Fx_ui_w_statusOfConfidentiality;
});